    ...
    <el-container>
        <el-header>
            <el-breadcrumb style="font-size: 150%" separator-class="el-icon-arrow-right">
                ...
                <el-breadcrumb-item>寻找失主</el-breadcrumb-item>
            </el-breadcrumb>
        ...
        <el-main>
            ...
            <el-row>
                <div style="margin-top: 10px"><el-col :span="2">
              ...
              <el-card :body-style="{ padding: '0px' }">
                ...
                <div style="padding: 14px;">
                  ...
                  <div class="bottom clearfix">
                    ...
                    <el-dialog title="失物详细信息" :visible.sync="dialogFormVisible" :show-close = "false" width="700px" :center="true">
                      <el-form :model="item">
