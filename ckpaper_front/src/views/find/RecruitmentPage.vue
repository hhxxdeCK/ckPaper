    ...
    <el-container>
        <el-header>
            <el-breadcrumb style="font-size: 150%" separator-class="el-icon-arrow-right">
                ...
                <el-breadcrumb-item>发布招领启事</el-breadcrumb-item>
            </el-breadcrumb>
        </el-header>
        <el-main>
            <el-form label-position='left' size="mini" ref="recruitment" :rules="rules" :model="recruitment" label-width="100px">
        ...
        data() {
            return {
              ...
              rules:{
                  ...
                  address:[{ required: true, message: '拾取地点不能为空', trigger: 'blur' }],
